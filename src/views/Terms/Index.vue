  ...
  <div class="terms pa-5 pages" v-if="shop">
    ...
    <section class="_section">
      ...
      <div class="terms-content pa-5">
        「台灣加密型實名制」隱私權及資訊安全政策<br>
台灣加密型實名制(以下簡稱本網站)重視並尊重您的隱私權，為了幫助您瞭解本網站如何收集、應用及保護您的個人資訊，請詳細閱讀以下隱私權暨資訊安全保護政策。<br>
<br>
- 適用範圍<br>
<br>
...
<br>
       為提供個人化的服務，方便您每次進行實名制，使用Localstorage在您首次輸入時建立及儲存，並在您登出時修改，追蹤保存您的資料。Localstorage是從網站傳送到瀏覽器，保存在使用者電腦硬碟中的資料。您可以在Netscape的「功能設定」的「進階」或是IE的「Internet選項」的「安全性」中選擇修改瀏覽器對Localstorage的接受程度。如果您選擇拒絕所有的Localstorage，可能無法部份個人化服務。<br>
<br>
- 資料的運用方式<br>
<br>
...
<br>
     ...
     如果您對於本網站的隱私權保護政策或是有個人資料收集、運用、更新等問題，請來信至信箱(hank85627@gmail.com)。<br>
      </div>
    </section>
